...
Using this subalgorithm, we can see how the code writing is simplified. It is important to note that for us to be able to use the **`turn_left()`** function, it needs to be defined and evaluated by R **before** we use it to solve our problem.
