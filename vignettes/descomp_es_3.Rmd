...
vignette: >
  %\VignetteIndexEntry{descomp_es_3}
...
## Girar a la derecha^[Algunos ejemplos presentados en este tutorial fueron adaptados de *Karel the robot learns Java* (Eric Roberts, 2005)]
